@section('title', 'Auto Direct Message') @include('default/header')
<script>
    $(".Message a").addClass("activeSidebar");
</script>
                ...
                <div class="d-flex flex-column w-xl b-r white modal-dialog">
                    <div class="scrollable hover">
                        <div class="list inset">
                            ...
                            <div class="list-item"><span class="w-40 avatar circle blue" style="background: linear-gradient(to right, #667eea, #764ba2)!important"><!-- <img src='{{ asset("$showaccounts->profilepic") }}' alt='.'> -->
                                    {{ mb_strtoupper(mb_substr($showaccounts->username, 0, 2)) }}
                                </span>
                                <div class="list-body"><a href="{{ url('auto-message/'.$showaccounts->username) }}" class="item-title _500">{{ $showaccounts->username }}
                    ...
                    <div class="col-sm">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="box text-center" style="max-height: 280px;min-height: 280px;">
                                    <div class="p-4">
                                        <p><img src='{{ asset("$photo") }}' alt='.' class='circle w-56'></p>
                        ...
                        <form method="POST" action="{{ url('updatemessage') }}">
                            ...
                            <div class="box">
                                <label class="form-control myLabel">Auto Direct Message for <b>{{ $username }}</b></label>
                                <div class="box-body">
                                    ...
                                    <div class="input-group">
                                        <div class="col-sm" id="spanInsertUsername">
                                            ...
                                            <span class="badge badge-dark">{{ $showtarget }} &nbsp; @php $target = str_replace("#", "$", $showtarget); @endphp <a href="{{ url('deletetarget/'.$username.'/message/'.$target) }}"><i class="fas fa-times"></i></a></span> @endforeach @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="inputGroup form">
                                                ...
                                                <label for="option1">Message to selected user's followers</label>
                                            </div>
                                        </div>
                                        <div class="col-sm">
                                            <div class="inputGroup form">
                                                ...
                                                <label for="option2">Message to selected user's followings</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-style-7" style="width: 100%;max-width: 100%">
                                        <ul>
                                            <li>
                                                ...
                                                <span>If user's follower quantity less than XX don't send message and continue another user. Leave it blank for deactivate.</span>
                                            </li>
                                            <li>
                                                <label>Media Count</label>
                                                <input type="number" name="botdetect2" value="{{ $botdetect2 }}" autocomplete="off">
                                                <span>If user's media count less than XX don't send message and continue another user. Leave it blank for deactivate.</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <p><br>
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class='input-group mb-3'>
                                                <div class="select animated zoomIn">
                                                    <input type="radio" name="captiongroup" required="">
                                                    <i class="toggle icon icon-arrow-down"></i>
                                                    <i class="toggle icon icon-arrow-up"></i>
