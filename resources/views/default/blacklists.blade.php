@section('title', 'Blacklist Groups') @include('default/header')
<script>
...
<div class="col-md-12 content-main">
    <ul class="nav nav-pills mb-3">
        <li class="nav-item">
            <a class="nav-link linkone" href="{{ url('captions') }}" style="height: 57px;">
                <div>
        ...
        <li class="nav-item">
            <a class="nav-link active linkthree" href="{{ url('blacklists') }}" style="height: 57px;">
                <div>
                ...
                <div class="d-flex flex-column w-xl b-r white modal-dialog">
                    <div class="scrollable hover">
                        <div class="list inset">
                            <div class="list-item">
                                <a href="{{ url('blacklists') }}" class="btn btn-primary specialbutton mainbutton">Add new blacklist</a>
                            </div>
                            ...
                            <div class="list-item">
                                <a href="{{ url('blacklists/'.$showgroups->groupname) }}">
                                ...
                                <div class="list-body" style="margin-top: 5px">
                                    <a href="{{ url('blacklists/'.$showgroups->groupname) }}" class="item-title _500">{{ $showgroups->groupname }}</a>
                ...
                <div class="d-flex flex" data-plugin="chat">
                    <div class="col-sm">
                        <form method="POST" action="{{ url('addblacklist') }}">
                            @csrf
                            <div class="box">
                                <label class="form-control myLabel">Add new Blacklist Groups</label>
                                <div class="box-body">
                                        ...
                                        <ul>
                                            <div id="ifYes" style="display: none;">
                                                <li>
                                                    ...
                                                    <span>Enter a group name for blacklists.</span>
                                                </li><br>
                                            </div>
                                            <li>
                                                <label>Blacklist</label>
                                                <input type="text" required="" class="form-control" name="blacklist" value="">
                                                <span>If there are accounts you want block, enter this field. Please add one by one..</span>
                                            </li>
                                        </ul>
                                    </div><p><br>

                                    <div class="text-left">
                                        <button type="submit" class="btn btn-primary specialbutton specialsmall mainbutton">Add blacklist</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="text-left">
                                    ...
                                    <p>
                                        <div style="text-align: left" class="btn btn-secondary btn-sm">{{ $showlist->blacklist }} <a href="{{ url('deleteblacklist/'.$edituser.'/'.$showlist->id) }}"><i class="fas fa-times"></i></a></div>
                                    </p>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog animate" id="animate">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ url('deleteblacklistgroup/'.$edituser) }}" class="btn danger p-x-md modbtn">Yes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
