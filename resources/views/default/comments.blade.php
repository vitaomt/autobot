@section('title', 'Comment Groups') @include('default/header')
<script>
...
<div class="col-md-12 content-main">
    <ul class="nav nav-pills mb-3">
        ...
        <li class="nav-item">
            <a class="nav-link active linktwo" href="{{ url('comments') }}" style="height: 57px;">
                <div>
                ...
                <div class="d-flex flex-column w-xl b-r white modal-dialog">
                    <div class="scrollable hover">
                        <div class="list inset">
                            <div class="list-item">
                                <a href="{{ url('comments') }}" class="btn btn-primary specialbutton mainbutton">Add new comment</a>
                            </div>
                            ...
                            <div class="list-item">
                                <a href="{{ url('comments/'.$showgroups->groupname) }}">
                                ...
                                <div class="list-body" style="margin-top: 5px">
                                    <a href="{{ url('comments/'.$showgroups->groupname) }}" class="item-title _500">{{ $showgroups->groupname }}</a>
                ...
                <div class="d-flex flex" data-plugin="chat">
                    <div class="col-sm">
                        <form method="POST" action="{{ url('addcomment') }}">
                            @csrf
                            <div class="box">
                                <label class="form-control myLabel">Add new Comment Groups</label>
                                <div class="box-body">
                                        ...
                                        <ul>
                                            <div id="ifYes" style="display: none;">
                                                <li>
                                                    ...
                                                    <span>Enter a group name for comments.</span>
                                                </li><br>
                                            </div>
                                            <li>
                                                <label>Comment</label>
                                                <input type="text" required name="comment" value="" autocomplete="off"></input>
                                                <span>Enter a comment with #hashtags.</span>
                                            </li>
                                        </ul>
                                    </div><p><br>

                                    <div class="text-left">
                                        <button type="submit" class="btn btn-primary specialbutton specialsmall mainbutton">Add comment</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="text-left">
                                    ...
                                    <p>
                                        <div style="text-align: left" class="btn btn-secondary btn-sm">{{ $showlist->comment }} <a href="{{ url('deletecomment/'.$edituser.'/'.$showlist->id) }}"><i class="fas fa-times"></i></a></div>
                                    </p>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog animate" id="animate">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ url('deletecommentgroup/'.$edituser) }}" class="btn danger p-x-md modbtn">Yes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
