...
{  
    ...
    {  
        ...
        $this->checkPhpVersion('7.1.3', '<');
        $this->checkMySqlVersion('5.7', '<');
    ...
    public function checkPhpVersion($required = null, $condition = null)
    {
        if (version_compare(phpversion(), $required, $condition)) {
            ...
            //success
            $this->versions['php'] = "<i class='fa fa-ok green'></i> You need to<strong class='green'> PHP $required</strong> or greater. <strong>(current version ".phpversion().")</strong>";
        } 
