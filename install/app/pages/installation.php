        ...
        <div class="col-sm-12">
            <form action="./app/controller/Setup_process.php" method="post" class="form-horizontal" id="setupForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="app_name" placeholder="App Name" name="app_name" value="Autobot" readonly>
                    </div>
                </div>
                <!-- App URL -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p class="green upload-message" id="upload-help-block">
                          The Upload SQL File field is required
                        </p>                
                    </div>
                </div>
                ...
                <!-- App Name -->
                <div class="form-group">
                    <label for="code"  class="col-sm-4 control-label">Codecanyon Purchase Code</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="code" placeholder="aaaaaa-bbbb-cccc-dddddd" name="code" value="">
                    </div>
                </div>
